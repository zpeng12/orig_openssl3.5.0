...
__owur unsigned int SSL_CIPHER_get_id(const SSL_CIPHER *c);
__owur unsigned short int SSL_CIPHER_get_protocol_id(const SSL_CIPHER *c);
...
void SSL_SESSION_get0_ticket(const SSL_SESSION *s, const unsigned char **tick,
                             size_t *len);
__owur unsigned int SSL_SESSION_get_max_early_data(const SSL_SESSION *s);
...
__owur int SSL_CTX_dane_mtype_set(SSL_CTX *ctx, const EVP_MD *md,
                                  unsigned char mtype, unsigned char ord);
__owur int SSL_dane_enable(SSL *s, const char *basedomain);
__owur int SSL_dane_tlsa_add(SSL *s, unsigned char usage, unsigned char selector,
                             unsigned char mtype, const unsigned char *data, size_t dlen);
__owur int SSL_get0_dane_authority(SSL *s, X509 **mcert, EVP_PKEY **mspki);
__owur int SSL_get0_dane_tlsa(SSL *s, unsigned char *usage, unsigned char *selector,
                              unsigned char *mtype, const unsigned char **data,
                              size_t *dlen);
/*
...
__owur int SSL_sendfile(SSL *s, int fd, long offset, size_t size,
                                 int flags);
...
unsigned char SSL_SESSION_get_max_fragment_length(const SSL_SESSION *sess);
