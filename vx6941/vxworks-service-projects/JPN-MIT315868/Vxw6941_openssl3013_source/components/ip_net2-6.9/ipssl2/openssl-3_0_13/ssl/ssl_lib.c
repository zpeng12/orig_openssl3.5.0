...
int SSL_CTX_set_max_early_data(SSL_CTX *ctx, unsigned int max_early_data)
{
...
unsigned int SSL_CTX_get_max_early_data(const SSL_CTX *ctx)
{
    return ctx->max_early_data;
}

int SSL_set_max_early_data(SSL *s, unsigned int max_early_data)
{
...
unsigned int SSL_get_max_early_data(const SSL *s)
{
    return s->max_early_data;
}

int SSL_CTX_set_recv_max_early_data(SSL_CTX *ctx, unsigned int recv_max_early_data)
{
...
unsigned int SSL_CTX_get_recv_max_early_data(const SSL_CTX *ctx)
{
    return ctx->recv_max_early_data;
}

int SSL_set_recv_max_early_data(SSL *s, unsigned int recv_max_early_data)
{
...
unsigned int SSL_get_recv_max_early_data(const SSL *s)
{
