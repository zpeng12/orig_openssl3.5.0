...
#include "internal/refcount.h"		/*CRYPTO_REF_COUNT*/

/*# include <openssl/ossl_lib_ctx_st.h>*/	/*error*/
...
struct bio_st {
    ...
    const struct bio_method_st *method;
...
#if 0
#if !defined(BIO)		/*forwarddeclaration compatibility*/
typedef struct bio_st BIO;
typedef struct bio_st st_BIO;	/*unnamed prototyped parameters not allowed when body is present*/
#endif
#endif
...
# ifndef OPENSSL_NO_DEPRECATED_3_0
OSSL_DEPRECATEDIN_3_0 BIO_callback_fn BIO_get_callback(const struct bio_st *b);
OSSL_DEPRECATEDIN_3_0 void BIO_set_callback(struct bio_st *b, BIO_callback_fn callback);
OSSL_DEPRECATEDIN_3_0 long BIO_debug_callback(struct bio_st *bio, int cmd,
                                               const char *argp, int argi,
                                               long argl, long ret);
# endif

BIO_callback_fn_ex BIO_get_callback_ex(const struct bio_st *b);
void BIO_set_callback_ex(struct bio_st *b, BIO_callback_fn_ex callback);
long BIO_debug_callback_ex(struct bio_st *bio, int oper, const char *argp, size_t len,
...
SKM_DEFINE_STACK_OF_INTERNAL(BIO, BIO, BIO)
   ...
   /* STACK_OF(BIO); */
struct stack_st_BIO;
    typedef int (*sk_BIO_compfunc)(const struct bio_st * const *a, const struct bio_st *const *b); 
    typedef void (*sk_BIO_freefunc)(struct bio_st *a); 
    typedef struct bio_st * (*sk_BIO_copyfunc)(const struct bio_st *a); 
    static ossl_unused ossl_inline struct bio_st *ossl_check_BIO_type(struct bio_st *ptr) 
    { 
        return ptr; 
    } 
    static ossl_unused ossl_inline const struct stack_st *ossl_check_const_BIO_sk_type(const struct stack_st_BIO *sk) 
    { 
        return (const struct stack_st *)sk; 
    } 
    static ossl_unused ossl_inline struct stack_st *ossl_check_BIO_sk_type(struct stack_st_BIO *sk) 
    { 
        return (struct stack_st *)sk;
    } 
    static ossl_unused ossl_inline int ossl_check_BIO_compfunc_type(int cmp) 
    { 
        return (int)cmp;
    } 
    static ossl_unused ossl_inline void* ossl_check_BIO_copyfunc_type(struct bio_st* cpy) 
    { 
        return (void*)cpy;
    } 
...
typedef int asn1_ps_func (struct bio_st *b, unsigned char **pbuf, int *plen,
                          void *parg);

typedef void (*BIO_dgram_sctp_notification_handler_fn) (struct bio_st *b,
                                                        void *context,
                                                        void *buf);
# ifndef OPENSSL_NO_SCTP
 ...
 */
int BIO_read_filename(struct bio_st *b, const char *name);
# else
...
size_t BIO_ctrl_pending(struct bio_st *b);
size_t BIO_ctrl_wpending(struct bio_st *b);
...
size_t BIO_ctrl_get_write_guarantee(struct bio_st *b);
size_t BIO_ctrl_get_read_request(struct bio_st *b);
...
uint64_t BIO_number_read(struct bio_st *bio);
uint64_t BIO_number_written(struct bio_st *bio);

/* For BIO_f_asn1() */
int BIO_asn1_set_prefix(struct bio_st *b, asn1_ps_func *prefix,
                        asn1_ps_func *prefix_free);
int BIO_asn1_get_prefix(struct bio_st *b, asn1_ps_func **pprefix,
                        asn1_ps_func **pprefix_free);
int BIO_asn1_set_suffix(struct bio_st *b, asn1_ps_func *suffix,
                        asn1_ps_func *suffix_free);
int BIO_asn1_get_suffix(struct bio_st *b, asn1_ps_func **psuffix,
                        asn1_ps_func **psuffix_free);

const BIO_METHOD *BIO_s_file(void);
struct bio_st *BIO_new_file(const char *filename, const char *mode);
struct bio_st *BIO_new_from_core_bio(struct ossl_lib_ctx_st *libctx, OSSL_CORE_BIO *corebio);
# ifndef OPENSSL_NO_STDIO
struct bio_st *BIO_new_fp(FILE *stream, int close_flag);
# endif
struct bio_st *BIO_new_ex(struct ossl_lib_ctx_st *libctx, const BIO_METHOD *method);
struct bio_st *BIO_new(const BIO_METHOD *type);
...
int BIO_read_ex(struct bio_st *b, void *data, size_t dlen, size_t *readbytes);
...
int BIO_write_ex(struct bio_st *b, const void *data, size_t dlen, size_t *written);
...
long BIO_callback_ctrl(struct bio_st *b, int cmd, BIO_info_cb *fp);
...
int BIO_dgram_sctp_notification_cb(struct bio_st *b,
...
# endif
int BIO_wait(struct bio_st *bio, time_t max_time, unsigned int nap_milliseconds);
...
# endif
int BIO_hex_string(struct bio_st *out, int indent, int width, const void *data,
                   int datalen);
...
int BIO_new_bio_pair(struct bio_st **bio1, size_t writebuf1,
                     struct bio_st **bio2, size_t writebuf2);
/*
...
int (*BIO_meth_get_write(const BIO_METHOD *biom)) (struct bio_st *, const char *, int);
int (*BIO_meth_get_write_ex(const BIO_METHOD *biom)) (struct bio_st *, const char *, size_t,
                                                size_t *);
int BIO_meth_set_write(BIO_METHOD *biom,
                       int (*write) (struct bio_st *, const char *, int));
int BIO_meth_set_write_ex(BIO_METHOD *biom,
                       int (*bwrite) (struct bio_st *, const char *, size_t, size_t *));
int (*BIO_meth_get_read(const BIO_METHOD *biom)) (struct bio_st *, char *, int);
int (*BIO_meth_get_read_ex(const BIO_METHOD *biom)) (struct bio_st *, char *, size_t, size_t *);
int BIO_meth_set_read(BIO_METHOD *biom,
                      int (*read) (struct bio_st *, char *, int));
int BIO_meth_set_read_ex(BIO_METHOD *biom,
                         int (*bread) (struct bio_st *, char *, size_t, size_t *));
int (*BIO_meth_get_puts(const BIO_METHOD *biom)) (struct bio_st *, const char *);
int BIO_meth_set_puts(BIO_METHOD *biom,
                      int (*puts) (struct bio_st *, const char *));
int (*BIO_meth_get_gets(const BIO_METHOD *biom)) (struct bio_st *, char *, int);
int BIO_meth_set_gets(BIO_METHOD *biom,
                      int (*ossl_gets) (struct bio_st *, char *, int));
long (*BIO_meth_get_ctrl(const BIO_METHOD *biom)) (struct bio_st *, int, long, void *);
int BIO_meth_set_ctrl(BIO_METHOD *biom,
                      long (*ctrl) (struct bio_st *, int, long, void *));
int (*BIO_meth_get_create(const BIO_METHOD *bion)) (struct bio_st *);
int BIO_meth_set_create(BIO_METHOD *biom, int (*create) (struct bio_st *));
int (*BIO_meth_get_destroy(const BIO_METHOD *biom)) (struct bio_st *);
int BIO_meth_set_destroy(BIO_METHOD *biom, int (*destroy) (struct bio_st *));
long (*BIO_meth_get_callback_ctrl(const BIO_METHOD *biom))
                                 (struct bio_st *, int, BIO_info_cb *);
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (struct bio_st *, int,
                                                      BIO_info_cb *));
