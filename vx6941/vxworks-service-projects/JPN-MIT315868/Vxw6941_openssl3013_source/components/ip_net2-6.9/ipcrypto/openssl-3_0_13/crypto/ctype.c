...
static const int case_change_mode = 0x40;
#else
static const int case_change_mode = 0x20;
#endif
...
int ossl_tolower(int c)
{
    ...
    return ASCII_IS_UPPER(a) ? c ^ case_change_mode : c;
}
...
int ossl_toupper(int c)
{
    ...
    return ASCII_IS_LOWER(a) ? c ^ case_change_mode : c;
}
