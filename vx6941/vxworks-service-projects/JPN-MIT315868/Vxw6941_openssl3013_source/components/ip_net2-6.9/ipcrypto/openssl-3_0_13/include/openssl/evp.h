...
int EVP_MD_names_do_all(const EVP_MD *md,
                        ...
                        void *data);
const struct ossl_provider_st *EVP_MD_get0_provider(const EVP_MD *md);
...
int EVP_CIPHER_names_do_all(const EVP_CIPHER *cipher,
                            void (*fn)(const char *name, void *data),
                            void *data);
const struct ossl_provider_st *EVP_CIPHER_get0_provider(const EVP_CIPHER *cipher);
...
const struct ossl_provider_st *EVP_MAC_get0_provider(const EVP_MAC *mac);
...
const struct ossl_provider_st *EVP_RAND_get0_provider(const EVP_RAND *rand);
...
const struct ossl_provider_st *EVP_PKEY_get0_provider(const EVP_PKEY *key);
...
const struct ossl_provider_st *EVP_KEYMGMT_get0_provider(const EVP_KEYMGMT *keymgmt);
...
struct ossl_provider_st *EVP_SIGNATURE_get0_provider(const EVP_SIGNATURE *signature);
...
struct ossl_provider_st *EVP_ASYM_CIPHER_get0_provider(const EVP_ASYM_CIPHER *cipher);
...
struct ossl_provider_st *EVP_KEM_get0_provider(const EVP_KEM *wrap);
...
EVP_KEYEXCH *EVP_KEYEXCH_fetch(OSSL_LIB_CTX *ctx, const char *algorithm,
                               const char *properties);
struct ossl_provider_st *EVP_KEYEXCH_get0_provider(const EVP_KEYEXCH *exchange);
...
const struct ossl_provider_st *EVP_PKEY_CTX_get0_provider(const EVP_PKEY_CTX *ctx);
