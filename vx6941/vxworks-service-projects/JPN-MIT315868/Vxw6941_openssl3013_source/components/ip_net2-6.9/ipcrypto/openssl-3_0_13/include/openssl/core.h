...
typedef int (OSSL_provider_init_fn)(const OSSL_CORE_HANDLE *handle,
                                    const struct ossl_dispatch_st *in,
                                    const struct ossl_dispatch_st **out,
                                    void **provctx);
# ifdef __VMS
#  pragma names save
 ...
 */
typedef int (OSSL_CALLBACK)(const struct ossl_param_st params[], void *arg);
typedef int (OSSL_INOUT_CALLBACK)(const struct ossl_param_st in_params[],
                                  struct ossl_param_st out_params[], void *arg);
/*
...
typedef int (OSSL_PASSPHRASE_CALLBACK)(char *pass, size_t pass_size,
                                       size_t *pass_len,
                                       const struct ossl_param_st params[], void *arg);
