...
int ossl_method_store_add(OSSL_METHOD_STORE *store, const struct ossl_provider_st *prov,
...
int ossl_method_store_fetch(OSSL_METHOD_STORE *store,
                            ...
                            const struct ossl_provider_st **prov, void **method);
int ossl_method_store_remove_all_provided(OSSL_METHOD_STORE *store,
                                          const struct ossl_provider_st *prov);
...
int ossl_method_store_cache_get(OSSL_METHOD_STORE *store, struct ossl_provider_st *prov,
                                int nid, const char *prop_query, void **result);
int ossl_method_store_cache_set(OSSL_METHOD_STORE *store, struct ossl_provider_st *prov,
                                int nid, const char *prop_query, void *result,
                                int (*method_up_ref)(void *),
                                void (*method_destruct)(void *));
