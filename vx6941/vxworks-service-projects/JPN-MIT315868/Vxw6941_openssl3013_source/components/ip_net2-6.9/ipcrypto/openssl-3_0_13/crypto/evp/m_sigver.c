                          ...
                          const OSSL_PARAM params[])
{
    ...
    const struct ossl_provider_st *tmp_prov = NULL;
    ...
    for (iter = 1, provkey = NULL; iter < 3 && provkey == NULL; iter++) {
        ...
        case 2:
            ...
            signature =
                evp_signature_fetch_from_prov((struct ossl_provider_st *)tmp_prov,
        ...
        tmp_keymgmt_tofree = tmp_keymgmt =
            evp_keymgmt_fetch_from_prov((struct ossl_provider_st *)tmp_prov,
