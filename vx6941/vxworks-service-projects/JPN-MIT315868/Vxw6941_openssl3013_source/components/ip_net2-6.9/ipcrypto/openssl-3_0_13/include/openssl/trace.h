 ...
 */
int OSSL_trace_set_channel(int category, struct bio_st* channel);
 ...
 */
struct bio_st *OSSL_trace_begin(int category);
void OSSL_trace_end(int category, struct bio_st *channel);
