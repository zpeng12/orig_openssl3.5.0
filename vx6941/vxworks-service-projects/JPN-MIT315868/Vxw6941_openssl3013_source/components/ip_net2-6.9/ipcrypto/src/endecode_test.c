...
const OPTIONS *test_encoder_decoder_test_get_options(void)
{
...
# endif
    ...
    if (ok) {
        ...
        ADD_TEST_SUITE_LEGACY(DSA);		/*2*/
        ADD_TEST_SUITE_MSBLOB(DSA);		/*2*/
        ADD_TEST_SUITE_UNPROTECTED_PVK(DSA);			/*1*/
# ifndef OPENSSL_NO_RC4
        ADD_TEST_SUITE_PROTECTED_PVK(DSA);		/*1*/
# endif
#endif
         ...
         * so no legacy tests.
         */
        ADD_TEST_SUITE_MSBLOB(RSA);					/*2*/
        ADD_TEST_SUITE_UNPROTECTED_PVK(RSA);		/*1*/
# ifndef OPENSSL_NO_RC4
        ADD_TEST_SUITE_PROTECTED_PVK(RSA);		/*1*/
# endif
    }
...
void test_encoder_decoder_cleanup_tests(void)
{
#ifndef OPENSSL_NO_EC
