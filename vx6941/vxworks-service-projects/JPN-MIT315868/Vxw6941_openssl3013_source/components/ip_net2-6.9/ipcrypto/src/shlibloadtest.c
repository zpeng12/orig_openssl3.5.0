...
/*invalid redeclaration of type name "DSO" (declared at line 57 of 
"components/ip_net2-6.9/ipcrypto/openssl-3_0_13/include/internal/dso.h*/
#ifdef DSO
#undef DSO
typedef void DSO;
#endif
 ...
 */
int test_shlibload(int argc, char *argv[])
{
    const char *p;
