...
static int test_x509_check_cert_pkey_local(void)
{
    BIO *bio = NULL;
    X509 *x509 = NULL;
...
const OPTIONS *test_x509_check_cert_pkey_test_get_options(void)
{
    enum { OPT_TEST_ENUM };
...
int test_x509_check_cert_pkey(void)
{
    ...
    ADD_TEST(test_x509_check_cert_pkey_local);
    return 1;
}
