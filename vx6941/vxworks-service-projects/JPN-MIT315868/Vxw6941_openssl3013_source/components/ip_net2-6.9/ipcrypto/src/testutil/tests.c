...
char *test_strcut(char str[],int m)
{
    int p=0;
                              ...
                              const char *op)
{
    ...
    if (file != NULL) {
        test_printf_stderr(" @ %s:%d", test_strcut(file, 30), line);
    }
    test_printf_stderr("\n");
}
                              ...
                              const char *op, const char *fmt, ...)
{
    ...
    va_start(ap, fmt);
    printf("........%s: file=%s, line=%d.\r\n", __FUNCTION__, test_strcut(file, 30), line);
#if 0
    printf("........%s: desc=%s.\r\n", __FUNCTION__, fmt);
...
#endif
DEFINE_COMPARISON(double, double, eq, ==, "%g")                        
DEFINE_COMPARISON(double, double, ne, !=, "%g")                       
DEFINE_COMPARISON(double, double, lt, <, "%g")                         
DEFINE_COMPARISON(double, double, le, <=, "%g")                        
DEFINE_COMPARISON(double, double, gt, >, "%g")                         
DEFINE_COMPARISON(double, double, ge, >=, "%g")


#if 0
DEFINE_COMPARISONS(size_t, size_t, "%zu")
#endif
DEFINE_COMPARISON(size_t, size_t, eq, ==, "%zu")                          
DEFINE_COMPARISON(size_t, size_t, ne, !=, "%zu")                          
DEFINE_COMPARISON(size_t, size_t, lt, <, "%zu")                           
DEFINE_COMPARISON(size_t, size_t, le, <=, "%zu")                          
DEFINE_COMPARISON(size_t, size_t, gt, >, "%zu")                           
DEFINE_COMPARISON(size_t, size_t, ge, >=, "%zu")
...
int test_true(const char *file, int line, const char *s, int b)
{
    if (b)
        return 1;
    test_fail_message(NULL, file, line, "bool", "........", "true", "==", "false");
    return 0;
}
...
int test_str_eq(const char *file, int line, const char *sname1, const char *sname2,
                const char *s1, const char *s2)
{
    if (s1 == NULL && s2 == NULL)
      return 1;		/*?????*/
                 ...
                 const char *s1, size_t n1, const char *s2, size_t n2)
{
	...
	if(s1 != NULL)
		printf("........test_strn_eq error, %s = %s, n1 = %d.\r\n ",st1, s1, n1);
	if(s2 != NULL)
		printf("........test_strn_eq error, %s = %s, n2 = %d.\r\n ",st2, s2, n2);
        return 0;
    }
    return 1;
}
                 ...
                 const char *s1, size_t n1, const char *s2, size_t n2)
{
	...
	if(s1 != NULL)
		printf("........test_strn_ne error, %s = %s, n1 = %d.\r\n ",st1, s1, n1);
	if(s2 != NULL)
		printf("........test_strn_ne error, %s = %s, n2 = %d.\r\n ",st2, s2, n2);
        return 0;
    }
    return 1;
}

int test_mem_eq(const char *funcname, int line, const char *st1, const char *st2,
                ...
                const void *s1, size_t n1, const void *s2, size_t n2)
{
	...
	if(s1 != NULL)
printf("........test_mem_ne error, %s = %s, n1 = %d.\r\n ",st1, s1, n1);
	if(s2 != NULL)
		printf("........test_mem_ne error, %s = %s, n2 = %d.\r\n ",st2, s2, n2);
        return 0;
    }
    return 1;
}
