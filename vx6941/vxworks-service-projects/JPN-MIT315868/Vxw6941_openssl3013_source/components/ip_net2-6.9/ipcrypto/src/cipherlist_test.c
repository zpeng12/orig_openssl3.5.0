...
static void tear_down_cipherlist_test(CIPHERLIST_TEST_FIXTURE *fixture)
{
    if (fixture != NULL) {
...
static CIPHERLIST_TEST_FIXTURE *set_up_cipherlist_test(const char *const test_case_name)
{
    ...
    if (!TEST_ptr(fixture->server = SSL_CTX_new(TLS_server_method()))
        ...
        tear_down_cipherlist_test(fixture);
        return NULL;
    }
    return fixture;
}
...
static int execute_test_cipherlist_test(CIPHERLIST_TEST_FIXTURE *fixture)
{
    return fixture != NULL
...
#define SETUP_CIPHERLIST_TEST_FIXTURE(set_up) \
    SETUP_TEST_FIXTURE(CIPHERLIST_TEST_FIXTURE, set_up)

#define EXECUTE_CIPHERLIST_TEST(tear_down_cipherlist_test) \
    EXECUTE_TEST(execute_test_cipherlist_test, tear_down_cipherlist_test)

static int test_default_cipherlist_implicit(void)
{
    SETUP_CIPHERLIST_TEST_FIXTURE(set_up_cipherlist_test);
    EXECUTE_CIPHERLIST_TEST(tear_down_cipherlist_test);
    return result;
}
