...
static struct ossl_provider_st *prov_null = NULL;
static struct ossl_lib_ctx_st *libctx = NULL;
...
static int run_file_tests(int i)
{
	...
	testfile = "evpciph_aes_common.txt";
...
const OPTIONS *evp_test_get_options(void)
{
...
void test_evp_cleanup_tests(void)
{
