...
const OPTIONS *test_provider_status_test_get_options(void)
{
...
static int test_provider_status_local(void)
{
    int ret = 0;
...
int test_provider_status(void)
{
    ...
    if (strcmp(provider_name, "fips") == 0) {
        ...
        ADD_TEST(test_provider_status_local);
    } else {
...
void test_provider_status_cleanup_tests(void)
{
