...
static struct ossl_provider_st *nullprov = NULL;
static struct ossl_provider_st *deflprov = NULL;
static struct ossl_provider_st *lgcyprov = NULL;
...
static int test_pkey_ctx_fail_without_provider(int tst)
{
    ...
    struct ossl_provider_st *tmpnullprov = NULL;
    EVP_PKEY_CTX *pctx = NULL;
...
const OPTIONS *test_evp_extra_test_get_options(void)
{
...
void test_evp_extra_cleanup_tests(void)
{
