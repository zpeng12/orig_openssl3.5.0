...
static int test_provider_def(OSSL_LIB_CTX **libctx, const char *name,
...
static int test_builtin_provider(void)
{
    ...
    ok =
        ...
        && test_provider_def(&libctx, name, NULL);
...
static int test_builtin_provider_with_child(void)
{
    ...
    /* test_provider_def will free libctx and unload legacy as part of the test */
    return test_provider_def(&libctx, name, legacy);
}
#endif
...
static int test_loaded_provider(void)
{
    ...
    /* test_provider_def will free libctx as part of the test */
    return test_provider_def(&libctx, name, NULL);
}
#endif
...
const OPTIONS *provider_test_get_options(void)
{
