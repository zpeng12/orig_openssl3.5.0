...
--------------------
01a,18sep12,r_w  modify SSLeay() usage for requirement WIND00347266
*/
...
#include "openssl/ssl2_compatibility.h"
#else
#include <rand.h>
#include <x509v3.h>
#endif
...
static bool rand_enough(int nread)
{
  ...
  return (bool)((nread > 500)?TRUE:FALSE);
}
#endif
...
#define SSL_CLIENT_CERT_ERR \
    ...
    case SSL_FILETYPE_ASN1:
#ifdef WM_SECURE_KEY_STORAGE
    if (NULL == (pkey = ipcom_key_db_pkey_get(data->set.keyid)))
        {
        failf(data, "unable to get private key\n");
        return 0;
        }
                  ...
                  int sockindex)
{
  ...
  char *crypto_free_file;
  int crypto_free_line;
  ...
  */
  ...
  CRYPTO_free(str, crypto_free_file, crypto_free_line);
...
size_t Curl_ossl_version(char *buffer, size_t size)
{
#if (SSLEAY_VERSION_NUMBER >= 0x905000)
  {
    ...
    sub[1]='\0';
    ssleay_value = (unsigned long)(SSLEAY_VERSION_NUMBER);
